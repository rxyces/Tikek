                ...
                <View className="flex-row justify-between items-center">
                    <View className="min-w-[110px] min-h-[50px] bg-[#24242D] items-center justify-center rounded-lg">
                        ...
                        <Text className="font-wsemibold text-[24px] text-white">
                            {ticketTypeData.user_asks.length == 0 ? "---" : "£" + Math.min(...ticketTypeData.user_asks.map(ask => parseFloat(ask.price)))}
                        </Text>
                    </View>
                    ...
                    <View className="min-w-[110px] min-h-[50px] bg-[#24242D] items-center justify-center rounded-lg">
                        ...
                        <Text className="font-wsemibold text-[24px] text-white">
                        {ticketTypeData.user_asks.length == 0 ? "---" : "£" + Math.max(...ticketTypeData.user_offers.map(ask => parseFloat(ask.price)))}
                        </Text>
                    </View>
                </View>
            </View>
